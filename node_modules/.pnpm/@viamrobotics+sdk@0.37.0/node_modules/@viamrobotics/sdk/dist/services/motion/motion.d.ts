...
import type { GeoGeometry, GeoPoint, Geometry, Pose, PoseInFrame, Resource, ResourceName, Transform, WorldState } from '../../types';
import type { Constraints, GetPlanResponse, ListPlanStatusesResponse, MotionConfiguration } from './types';
/**
...
export interface Motion extends Resource {
     ...
     */
    move: (destination: PoseInFrame, componentName: ResourceName, worldState?: WorldState, constraints?: Constraints, extra?: Struct) => Promise<boolean>;
    /**
     ...
     */
    moveOnMap: (destination: Pose, componentName: ResourceName, slamServiceName: ResourceName, motionConfiguration?: MotionConfiguration, obstacles?: Geometry[], extra?: Struct) => Promise<string>;
    /**
     ...
     *   while navigating
     */
    moveOnGlobe: (destination: GeoPoint, componentName: ResourceName, movementSensorName: ResourceName, heading?: number, obstaclesList?: GeoGeometry[], motionConfiguration?: MotionConfiguration, boundingRegion?: GeoGeometry[], extra?: Struct) => Promise<string>;
    /**
     ...
     */
    getPlan: (componentName: ResourceName, lastPlanOnly?: boolean, executionId?: string, extra?: Struct) => Promise<GetPlanResponse>;
    /**
     ...
     *   are executing.
     */
    listPlanStatuses: (onlyActivePlans?: boolean, extra?: Struct) => Promise<ListPlanStatusesResponse>;
    /**
     ...
     *   reference frames that are needed to compute the component's `Pose`.
     */
    getPose: (componentName: ResourceName, destinationFrame: string, supplementalTransforms: Transform[], extra?: Struct) => Promise<PoseInFrame>;
}
