...
export declare const EncoderProperties: typeof encoderApi.GetPropertiesResponse, EncoderPositionType: typeof encoderApi.PositionType;
...
export interface Encoder extends Resource {
     ...
     *   degrees)
     */
    getPosition(positionType?: EncoderPositionType, extra?: Struct): Promise<readonly [number, EncoderPositionType]>;
}
